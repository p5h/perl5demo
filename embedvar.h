...
#define PL_cow_meta_arena_first	(vTHX->Icow_meta_arena_first)
#define PL_cow_meta_arena_free	(vTHX->Icow_meta_arena_free)
#define PL_cow_meta_arena_next	(vTHX->Icow_meta_arena_next)
...
#define PL_in_sv_dump		(vTHX->Iin_sv_dump)
